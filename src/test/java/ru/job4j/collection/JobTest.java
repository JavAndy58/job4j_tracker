...
public class JobTest {
    ...
    public void whenComparatorByNameAndPriorityBack() {
        Comparator<Job> cmpNamePriorityBack =
                new JobDescByName().thenComparing(new JobAskByPriority());
    ...
    public void whenComparatorByNameBackAndPriorityBack() {
        Comparator<Job> cmpNameBackPriorityBack =
                new JobAscByName().thenComparing(new JobAskByPriority());
